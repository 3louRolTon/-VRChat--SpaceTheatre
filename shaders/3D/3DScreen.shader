...
Shader "TCL987/3D/Toggleable OU SBS"
{
	...
	SubShader
	{
		...
		{
			o.Emission = tex2D( _MainTex, i.vertexToFrag80 ).rgb;
			o.Alpha = 1;
		}
...
Node;AmplifyShaderEditor.SamplerNode;8;1068.214,-30.37531;Float;True;Property;_MainTex;Screen Texture;0;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
